...
pub mod tests {
    ...
    use crate::http::{self, parse_http_string, FormdataText, HTTPMethod};
    // Test parsing HTTP Requests from strings
    #[test]
    fn parse_http_string_works() {
        let req = parse_http_string(("GET /get-request-test HTTP/1.1\r\nHost: localhost:7878\r\nAccept-Encoding: gzip, deflate, br\r\nAccept: */*\r\nConnection: keep-alive".into(),
            vec![],
        ));
